...
class _SketchedX extends StatelessWidget {
  ...
  final String _startImage = 'assets/images/cross-start.png';
  final String _endImage = 'assets/images/cross-end.png';
...
class _SketchedO extends StatelessWidget {
  ...
  final String _image = 'assets/images/circle.png';
